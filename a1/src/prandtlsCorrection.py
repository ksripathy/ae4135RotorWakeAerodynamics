...
def prandtlsCorrectionSingleDOFv2(bladeQuantity, bladeRootLoc, annulusLoc, annulusTSR, axialInd, minValue = 1e-4):
    ...
    #Bound Prandtls correction to avoid divide by zero
    if fTotal < minValue:
        fTotal = minValue
